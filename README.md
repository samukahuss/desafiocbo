...
Toda infraestrutura foi criada em ohio (eastus2). O projeto tem um custo estimado de R$ 1495,77 no regime 730h pay-as-you-go (Varia de acordo com o dólar). A maior parte desse preço está no recursos, do mais caro para o mais barato: Application gateway, Banco de dados,  Virtual Machines, VPN e App Service. 
